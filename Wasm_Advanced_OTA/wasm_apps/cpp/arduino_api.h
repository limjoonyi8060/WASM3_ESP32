...
WASM_IMPORT("arduino", "printn") void printn(int32_t n);
WASM_IMPORT("arduino", "pinMode") void pinMode(uint32_t pin, uint32_t mode);
WASM_IMPORT("arduino", "digitalWrite")
void digitalWrite(uint32_t pin, uint32_t value);

// This is a convenience function
WASM_IMPORT("arduino", "getPinLED") uint32_t getPinLED(void);
WASM_IMPORT("arduino", "getGreeting")
void getGreeting(char *buff, size_t maxlen);
WASM_IMPORT("arduino", "getx") uint32_t getx(void);
WASM_IMPORT("arduino", "gety") uint32_t gety(void);
WASM_IMPORT("arduino", "getz") uint32_t getz(void);
WASM_IMPORT("arduino", "gettemp") uint32_t gettemp(void);
...
static inline void print(const char *s) { print(s, strlen(s)); }
